...
func Test_writerFailureExpr(t *testing.T) {
	...
	testMap := map[syntax.Node][][]wantSetup{
		...
		&syntax.CallExpr{Args: []syntax.Expr{oneLiteral, xIdent, twentyLiteral}, Fn: yIdent}: {
			...
			newExpectingWriters("1", 1, "rendering call expression: element 0: rendering literal int value int payload:", WithCallOption(CallOptionSingleLineComma)),
			...
			newExpectingWriters("20", 1, "rendering call expression: element 2: rendering literal int value int payload:", WithCallOption(CallOptionSingleLineComma)),
		...
		&syntax.ListExpr{List: []syntax.Expr{
			...
			newExpectingWriters("20", 1, "rendering list expression: element 3: rendering literal int value int payload:", WithListOption(ListOptionMultilineComma)),
		...
		&syntax.TupleExpr{List: []syntax.Expr{xIdent, yIdent, twentyLiteral}}: {
			...
			newExpectingWriters("20", 1, "rendering tuple expression: element 2: rendering literal int value int payload:", WithTupleOption(TupleOptionMultilineMultipleComma)),
