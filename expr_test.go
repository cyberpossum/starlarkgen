...
func Test_writerFailureExpr(t *testing.T) {
	...
	testMap := map[syntax.Node][][]wantSetup{
		...
		&syntax.CallExpr{Args: []syntax.Expr{oneLiteral, xIdent, twentyLiteral}, Fn: yIdent}: {
			...
			newExpectingWriters("1", 1, "rendering call expression: element 0: rendering literal int value:"),
			newExpectingWriters("x", 1, "rendering call expression: element 1: rendering ident Name:"),
			newExpectingWriters("20", 1, "rendering call expression: element 2: rendering literal int value:"),
			newExpectingWriters("y", 1, "rendering call expression Fn: rendering ident Name:"),
			newExpectingWriters("1", 1, "rendering call expression: element 0: rendering literal int value:", WithCallOption(CallOptionSingleLineComma)),
			newExpectingWriters("x", 1, "rendering call expression: element 1: rendering ident Name:", WithCallOption(CallOptionSingleLineComma)),
			newExpectingWriters("20", 1, "rendering call expression: element 2: rendering literal int value:", WithCallOption(CallOptionSingleLineComma)),
		...
		&syntax.Comprehension{
			...
			newExpectingWriters("foo", 1, "rendering comprehension Body: rendering ident Name:"),
		...
		&syntax.DictExpr{List: []syntax.Expr{&syntax.DictEntry{Key: xIdent, Value: yIdent}}}: {
			...
			newExpectingWriters("y", 1, "rendering dict expression: element 0: rendering dict entry Value: rendering ident Name:", WithDictOption(DictOptionMultilineComma)),
			newExpectingWriters("x", 1, "rendering dict expression: element 0: rendering dict entry Key: rendering ident Name:", WithDictOption(DictOptionMultilineComma)),
			newExpectingWriters(":", 1, "rendering dict expression: element 0: rendering dict entry COLON token:", WithDictOption(DictOptionMultilineComma)),
			newExpectingWriters(" ", 1, "rendering dict expression: element 0: rendering dict entry space:", WithDictOption(DictOptionMultilineComma)),
		...
		&syntax.ListExpr{List: []syntax.Expr{
			...
			newExpectingWriters("20", 1, "rendering list expression: element 3: rendering literal int value:"),
			...
			newExpectingWriters("foo", 1, "rendering list expression: element 0: rendering ident Name:", WithListOption(ListOptionMultilineComma)),
			newExpectingWriters("x", 1, "rendering list expression: element 1: rendering ident Name:", WithListOption(ListOptionMultilineComma)),
			newExpectingWriters("y", 1, "rendering list expression: element 2: rendering ident Name:", WithListOption(ListOptionMultilineComma)),
			newExpectingWriters("20", 1, "rendering list expression: element 3: rendering literal int value:", WithListOption(ListOptionMultilineComma)),
		...
		&syntax.Literal{Raw: "test"}: {
			newExpectingWriters("test", 1, "rendering literal raw value:"),
		},
		&syntax.Literal{Value: "test"}: {
			newExpectingWriters(`"test"`, 1, "rendering literal string value:"),
		},
		&syntax.Literal{Value: uint64(10)}: {
			newExpectingWriters("10", 1, "rendering literal uint64 value:"),
		},
		&syntax.Literal{Value: uint(10)}: {
			newExpectingWriters("10", 1, "rendering literal uint value:"),
		},
		&syntax.Literal{Value: int64(-10)}: {
			newExpectingWriters("-10", 1, "rendering literal int64 value:"),
		},
		&syntax.Literal{Value: big.NewInt(-10)}: {
			newExpectingWriters("-10", 1, "rendering literal *big.Int value:"),
		},
		...
		&syntax.SliceExpr{Hi: fooIdent, X: xIdent, Lo: twentyLiteral, Step: oneLiteral}: {
			...
			newExpectingWriters("1", 1, "rendering slice expression Step: rendering literal int value:"),
			newExpectingWriters("20", 1, "rendering slice expression Lo: rendering literal int value:"),
		},
		&syntax.TupleExpr{List: []syntax.Expr{xIdent, yIdent, twentyLiteral}}: {
			...
			newExpectingWriters("20", 1, "rendering tuple expression: element 2: rendering literal int value:"),
			newExpectingWriters(",", 2, "rendering tuple expression: COMMA token:"),
			newExpectingWriters(" ", 2, "rendering tuple expression: space:"),
			newExpectingWriters("x", 1, "rendering tuple expression: element 0: rendering ident Name:", WithTupleOption(TupleOptionMultilineMultipleComma)),
			newExpectingWriters("y", 1, "rendering tuple expression: element 1: rendering ident Name:", WithTupleOption(TupleOptionMultilineMultipleComma)),
			newExpectingWriters("20", 1, "rendering tuple expression: element 2: rendering literal int value:", WithTupleOption(TupleOptionMultilineMultipleComma)),
			...
			x = &syntax.IndexExpr{
				X: &syntax.DictExpr{List: []syntax.Expr{
					&syntax.DictEntry{Key: fooIdent, Value: &syntax.BinaryExpr{
						Op: syntax.EQL,
						X:  &syntax.CondExpr{Cond: fooLessBar, True: &syntax.DotExpr{X: fooIdent, Name: barIdent}, False: &syntax.ListExpr{List: []syntax.Expr{fooIdent, tenLiteral, barIdent}}},
